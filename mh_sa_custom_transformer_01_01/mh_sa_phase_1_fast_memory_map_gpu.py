"""
This script (mh_sat_phase_1_fast_memory_map_gpu.py) is the core "Brain Builder". It performs the heavy lifting of teaching the
...
def train_fast(epochs_, dataloader_, device_, optimizer_, criterion_, model_, save_dir_):
    print("--- Phase 1 Training (Fast Memory Map Mode - BULLETPROOF) BEGIN ---")
    model_.to(device_)
    model_.train()
