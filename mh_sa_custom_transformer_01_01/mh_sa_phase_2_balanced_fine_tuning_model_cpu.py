...
from mh_sa_algorithms_for_custom_transformer_model import (
    ...
    NUM_HEADS, D_FF, DROPOUT, load_liver_tokenizer
)
import sys
...
if __name__ == "__main__":
    ...
    pretrained_path = os.path.join("../mh_sa_custom_transformer_01_01/unsupervised_model_weights", "latest_checkpoint_27000.safetensors")
    save_dir = "../mh_sa_custom_transformer_01_01/supervised_model_weights"
